  ...
  sections: [
    ...
    // 11. DISEASE ASSESSMENT
    {
      ...
      fields: [
        {
          key: 'symptom_grid',
          label: 'Sheetapitta Symptom Grading (0=Absent, 1=Mild, 2=Moderate, 3=Severe)',
          type: 'assessment_grid',
          rows: [
            'Kandu (Pruritus)',
            'Varti (Wheals/Urticae)',
            'Damshta (Bite-like marks)',
            'Samsthana (Distribution)',
            'Shotha (Swelling/Angioedema)',
            'Toda (Pricking sensation)',
            'Vidaha (Burning)',
            'Kshanika Utpatti Vinash (Transient appearance & disappearance)',
            'UAS Score (Urticaria Activity Score)',
            'UCT Score (Urticaria Control Test)',
          ],
          columns: ['Baseline', 'Day 7', 'Day 14', 'Day 21', 'Day 43', 'Day 58', 'Day 73', 'Day 90'],
        },
        { key: 'uas7_bt', label: 'UAS7 – BT', type: 'number', hint: 'Urticaria Activity Score over 7 days (0–42)' },
        { key: 'uas7_at', label: 'UAS7 – AT', type: 'number' },
        { key: 'uct_bt', label: 'UCT – BT', type: 'number', hint: 'Urticaria Control Test (4–16; ≥12 = well controlled)' },
        { key: 'uct_at', label: 'UCT – AT', type: 'number' },
        { key: 'dlqi_bt', label: 'DLQI – BT', type: 'number', hint: 'Dermatology Life Quality Index (0–30)' },
        { key: 'dlqi_at', label: 'DLQI – AT', type: 'number' },
        {
          key: 'overall_effect',
