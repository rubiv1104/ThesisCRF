      ...
      fields: [
        {
          ...
          rows: [
            ...
            'Kasa (Cough)',
            'Wheeze / Ghurghurak Shabda',
            'Uras Gaurava (Chest Tightness)',
            'Ratrikaala Vriddhi (Nocturnal symptoms)',
            'Kapha Nishthivana (Sputum production)',
            'Pratishyaya (Rhinitis)',
            'Vyayama Asahishnutva (Exercise intolerance)',
            'Daurbalya (Fatigue)',
            'Nidranasha (Sleep disturbance)',
            'ACQ Score',
          ],
          columns: ['BT', 'Day 7', 'Day 14', 'Day 30', 'Day 45', 'Day 60', 'Day 90'],
        },
        { key: 'acq_bt', label: 'ACQ Score – BT', type: 'number', hint: 'Asthma Control Questionnaire' },
        { key: 'acq_at', label: 'ACQ Score – AT', type: 'number' },
        { key: 'act_bt', label: 'ACT Score – BT', type: 'number', hint: 'Asthma Control Test (5–25; ≥20 = well controlled)' },
        { key: 'act_at', label: 'ACT Score – AT', type: 'number' },
        {
          key: 'overall_effect',
